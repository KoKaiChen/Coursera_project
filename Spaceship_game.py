...
# 在CodeSkulptor上運行：https://py2.codeskulptor.org/#user51_pWYkcit80zqY4un_1.py
...
class Ship:
    ...
    def shoot(self):
        ...
        if started:
            ...
            missile_group.add(
                Sprite(missile_pos, missile_vel, self.angle, 0, missile_image, missile_info, missile_sound))
